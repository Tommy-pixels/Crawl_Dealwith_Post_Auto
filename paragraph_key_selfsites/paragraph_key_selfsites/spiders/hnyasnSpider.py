...
class HnyasnSpider(scrapy.Spider):
    name = 'hnyasnSpider'
    start_urls = [
        'https://www.hnyasn.com/',
        'https://www.hnyasn.com/gppzwz/',
        'https://www.hnyasn.com/spaqpz/',
        'https://www.hnyasn.com/pzcgpt/',
        'https://www.hnyasn.com/pzcxfw/'
    ]
    ...
    def parse_articleInfo(self, response, **kwargs):
        ...
        for article in articleList:
            ...
            article_url = 'https://www.hnyasn.com' + url_part
            try:
