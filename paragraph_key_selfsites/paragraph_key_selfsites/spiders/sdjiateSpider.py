...
class SdjiateSpider(scrapy.Spider):
    name = 'sdjiateSpider'
    start_urls = [
        'http://www.sdjiate.com/',
        'http://www.sdjiate.com/gupiaopz/',
        'http://www.sdjiate.com/ganggukh/',
        'http://www.sdjiate.com/wangshangpz/',
        'http://www.sdjiate.com/peizicx/'
    ]
    ...
    def parse_articleInfo(self, response, **kwargs):
        ...
        for article in articleList:
            ...
            article_url = 'http://www.sdjiate.com' + url_part
            try:
